...
import 'package:voice_assistants_ai/home_page_screen.dart';
import 'package:voice_assistants_ai/openai_service.dart';
import 'package:voice_assistants_ai/pallete.dart';

class AltHomePageScreen extends StatefulWidget {
  const AltHomePageScreen({super.key});

  @override
  State<AltHomePageScreen> createState() => _AltHomePageScreenState();
}

class _AltHomePageScreenState extends State<AltHomePageScreen> {
  ...
  submit(String textFieldQuestion) async {
    final speech = await openAiService.isArtPromptApi(textFieldQuestion);
